...
**Versione:** 0.1.4 (la versione di questo strumento - mostrata nel banner
...
├── tests/
│   └── test_flasher_protocol_clock.py <- l'unico file raccolto da pytest (4 test) - non eseguito dalla CI, vedi Verifica di onestà sopra
