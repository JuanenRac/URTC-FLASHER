...
├── tests/
│   └── test_flasher_protocol_clock.py <- el único archivo que recoge pytest (4 tests) - no lo ejecuta la CI, ver Comprobación de honestidad arriba
